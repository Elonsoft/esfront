...
import { CheckboxIconProps, CheckboxProps } from './components/Checkbox';
...
import { ListItemIconProps, ListItemOwnProps, ListItemTextProps } from './components/ListItem';
import { LoadingButtonProps } from './components/LoadingButton';
import { MadeByProps } from './components/MadeBy';
import { MenuListProps, MenuProps } from './components/Menu';
...
import { SnackbarCloseProps, SnackbarProps } from './components/Snackbar';
...
declare module './theming/DefaultPropsProvider/DefaultPropsProvider.types' {
  interface ComponentsPropsList {
    ...
    ESLink: LinkProps;
    ESListItem: ListItemOwnProps;
    ESListItemIcon: ListItemIconProps;
    ESListItemText: ListItemTextProps;
    ...
    ESSpinnerDashRing: SpinnerProps;
    ESSpinnerFadingBars: SpinnerProps;
    ESSpinnerFadingDots: SpinnerProps;
    ESSpinnerFadingDoubleRing: SpinnerProps;
    ESSpinnerFadingRing: SpinnerProps;
    ESSpinnerRing: SpinnerProps;
