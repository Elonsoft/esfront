...
/**
 * The Price displays information and actions relating to the current screen.
 */
export const Price = (inProps: PriceProps) => {
  ...
  return (
    <PriceRoot className={clsx(className, classes.root)} ownerState={ownerState} sx={sx}>
      ...
      <PriceCurrency className={classes.currency}>{getCurrencySymbol('ru-RU', currency)}</PriceCurrency>
