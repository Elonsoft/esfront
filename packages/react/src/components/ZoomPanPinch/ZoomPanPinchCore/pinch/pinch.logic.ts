...
export const handlePinchStart = (contextInstance: ReactZoomPanPinchContext, event: TouchEvent): void => {
...
export const handlePinchZoom = (contextInstance: ReactZoomPanPinchContext, event: TouchEvent): void => {
  const { contentComponent, pinchStartDistance } = contextInstance;
  const { scale } = contextInstance.transformState;
  const { limitToBounds, centerZoomedOut, zoomAnimation } = contextInstance.setup;
...
export const handlePinchStop = (contextInstance: ReactZoomPanPinchContext): void => {
