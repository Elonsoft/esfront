...
import { AnimationType, ReactZoomPanPinchContext, StateType } from '../models';
...
export const handleCancelAnimation = (contextInstance: ReactZoomPanPinchContext): void => {
...
export function animate(
  ...
  if (animationTime === 0) {
    ...
    handleSetupAnimation(contextInstance, animationName, animationTime, (step: number) => {
