...
export type UseSliderRootSlotProps<ExternalProps = any> = Omit<ExternalProps, keyof UseSliderRootSlotOwnProps> &
...
export type UseSliderThumbSlotProps<ExternalProps = any> = Omit<ExternalProps, keyof UseSliderThumbSlotOwnProps> &
...
export type UseSliderHiddenInputProps<ExternalProps = any> = Omit<ExternalProps, keyof UseSliderHiddenInputOwnProps> &
...
export interface UseSliderReturnValue {
   ...
   */
  getHiddenInputProps: <ExternalProps extends Record<string, unknown> = any>(
   ...
   */
  getRootProps: <ExternalProps extends Record<string, unknown> = any>(
    externalProps?: ExternalProps
   ...
   */
  getThumbProps: <ExternalProps extends Record<string, unknown> = any>(
    externalProps?: ExternalProps
