      ...
      <SFS>
        ...
        {!!Object.values(filters).filter(Boolean).length && (
          <SFSChips onDelete={onFiltersReset}>
            <Chips>
              {!!filters['1'] && (
                <Tooltip {...TooltipProps} title={locale === 'ru' ? 'Ответственный' : 'Responsible'}>
              ...
              {!!filters['2'] && (
                <Tooltip {...TooltipProps} title={locale === 'ru' ? 'Создатель' : 'Author'}>
              ...
              {!!filters['3'] && (
                <Tooltip {...TooltipProps} title={locale === 'ru' ? 'Статус задачи' : 'Task status'}>
              ...
              {!!filters['4'] && (
                <Tooltip {...TooltipProps} title={locale === 'ru' ? 'Этап выполнения' : 'Execution stage'}>
              ...
              {!!filters['5'] && (
                <Tooltip {...TooltipProps} title={locale === 'ru' ? 'Срок выполнения' : 'Deadline'}>
              ...
              {!!filters['6'] && (
                <Tooltip {...TooltipProps} title={locale === 'ru' ? 'Закрытие' : 'Closure'}>
