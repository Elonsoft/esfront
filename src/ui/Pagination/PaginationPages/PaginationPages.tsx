      ...
      <PaginationPagesPagination
        ...
        renderItem={(item) => {
          switch (item.type) {
            ...
            case 'next':
              return (
                <PaginationPagesButton
                  ...
                  size="sm"
                  aria-label={`${item.type === 'next' ? nextPageLabel : prevPageLabel}`}
                >
            ...
            case 'end-ellipsis':
              return (
                <PaginationPagesEllipsis className={classes.ellipsis}>
                  <DotsHorizontalIcon />
                </PaginationPagesEllipsis>
              );
            default:
              return (
                <PaginationPagesTooltip
                  ...
                  title={
                    <>
                      <ArrowLeftBoldIcon /> Ctrl <ArrowRightBoldIcon />
                    </>
                  }
                  placement="top"
                  arrow
