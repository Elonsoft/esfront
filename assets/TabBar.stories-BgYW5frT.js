...
}`,...(h=(B=c.parameters)==null?void 0:B.docs)==null?void 0:h.source},description:{story:"We can use `label` prop to add labels to `TabBarItem`.",...(C=(g=c.parameters)==null?void 0:g.docs)==null?void 0:C.description}}};const ne=["Demo","WithLabels"];export{m as Demo,c as WithLabels,ne as __namedExportsOrder,oe as default};
