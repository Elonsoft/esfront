        ...
        top: '0'
          ...
          <SidebarScrollable afterScroll={<SidebarDivider />}>
            <SidebarMenu behaviour={behaviour} exclusive={exclusive}>
              <SidebarItem selected closePopoverAfterClick={closePopoverAfterClick} component="button" icon={<IconAtLineW500 />} id="0" text={locale === 'en' ? 'Projects' : 'Проекты'} onClick={() => console.info(\`Projects\`)}>
                {[...Array(5)].map((_, i) => <SidebarItem key={i} inset selected={i === 2} text={(locale === 'en' ? 'Project' : 'Проект') + ' №' + i} onClick={() => console.info(\`Project \${i}\`)} />)}
              </SidebarItem>
              <SidebarItem closePopoverAfterClick={closePopoverAfterClick} icon={<IconAtLineW500 />} id="1" text={locale === 'en' ? 'Files' : 'Файлы'}>
...
}`,...(q=(b=u.parameters)==null?void 0:b.docs)==null?void 0:q.source}}};const Ee=["Demo"];export{u as Demo,Ee as __namedExportsOrder,De as default};
