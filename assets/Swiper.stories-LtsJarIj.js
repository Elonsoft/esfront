...
}`,...(z=(B=h.parameters)==null?void 0:B.docs)==null?void 0:z.source},description:{story:"Swiper is highly customizable. We can adjust `gap` between slides, override styles for swiper, swiper buttons and\npagination, or provide our own components via `buttonPrev`, `buttonNext` and `pagination` props.",...(F=(M=h.parameters)==null?void 0:M.docs)==null?void 0:F.description}}};const Ee=["Demo","Vertical","Customization"];export{h as Customization,y as Demo,v as Vertical,Ee as __namedExportsOrder,ke as default};
